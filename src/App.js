...
const App = () => {
  ...
  const initialState = {id: null, photo: '', name: '', company: '', email: '', phone: '', address: ''}
  ...
  const editUser = user => {
    ...
    setEditing(true)
    setSelectedUser({id: user.id, photo: user.photo, name: user.name, company: user.company, email: user.email, phone: user.phone, address: user.address})
    ...
    <div>
      <div className="container">
        ...
        <UserList   users={users}
                    ...
                    /> 
            {editing ? (<Fragment>
            <UserForm editing={editing} setEditing={setEditing}
